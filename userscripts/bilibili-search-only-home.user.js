// ==UserScript==
// @name         B站仅搜索首页
// @namespace    https://github.com/mintonight/Bilibili-Evolved
// @version      1.0.0
// @description  不依赖 Bilibili Evolved：B 站首页仅保留顶栏与居中搜索框，默认纯黑背景
// @author       mintonight
// @homepageURL  https://github.com/mintonight/Bilibili-Evolved/tree/feature/search-home/userscripts
// @supportURL   https://github.com/mintonight/Bilibili-Evolved/issues
...
`
  ...
  const mountUI = () => {
    ...
    hint.id = 'soh-hint'
    hint.textContent = 'B站仅搜索首页 · 不依赖 Bilibili Evolved'
